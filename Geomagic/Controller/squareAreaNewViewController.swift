...
class squareAreaNewViewController: UIViewController {
    ...
    @IBAction func tap10(_ sender: UITapGestureRecognizer) {
        square10.backgroundColor = #colorLiteral(red: 0.5096693635, green: 0.266243875, blue: 0.2682249546, alpha: 1)
        if resultValue < 15{
            resultValue += 1
        }
    ...
    @IBAction func tap11(_ sender: UITapGestureRecognizer) {
        square11.backgroundColor = #colorLiteral(red: 0.5096693635, green: 0.266243875, blue: 0.2682249546, alpha: 1)
        if resultValue < 15{
            resultValue += 1
        }
    ...
    @IBAction func tap12(_ sender: UITapGestureRecognizer) {
        square12.backgroundColor = #colorLiteral(red: 0.5096693635, green: 0.266243875, blue: 0.2682249546, alpha: 1)
        if resultValue < 15{
            resultValue += 1
        }
    ...
    @IBAction func tap13(_ sender: UITapGestureRecognizer) {
        square13.backgroundColor = #colorLiteral(red: 0.5096693635, green: 0.266243875, blue: 0.2682249546, alpha: 1)
        if resultValue < 15{
            resultValue += 1
        }
    ...
    @IBAction func tap14(_ sender: UITapGestureRecognizer) {
        square14.backgroundColor = #colorLiteral(red: 0.5096693635, green: 0.266243875, blue: 0.2682249546, alpha: 1)
        if resultValue < 15{
            resultValue += 1
        }
    ...
    @IBAction func tap15(_ sender: UITapGestureRecognizer) {
        square15.backgroundColor = #colorLiteral(red: 0.5096693635, green: 0.266243875, blue: 0.2682249546, alpha: 1)
        if resultValue < 15{
            resultValue += 1
        }
